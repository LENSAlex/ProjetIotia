...
namespace ClasseE_Covid.Promotion.Manager
{
    class ManagerFormation
    {
        ...
        //    string WebAPIUrl = "http://51.75.125.121:3007/Personne/Add/Promo/" + item.IdDepartement + "/" + item.NomFormation + "/" + item.DureeFormation + "/" + item.AnneePromotion + "/" + item.IdProfesseurPromotion;
