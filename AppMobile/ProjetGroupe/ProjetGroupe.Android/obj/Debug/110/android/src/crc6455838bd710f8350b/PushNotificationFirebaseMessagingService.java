...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ProjetGroupe.Droid.Services.PushNotificationFirebaseMessagingService, ProjetGroupe.Android", PushNotificationFirebaseMessagingService.class, __md_methods);
	}
	...
	public PushNotificationFirebaseMessagingService ()
	{
		...
		if (getClass () == PushNotificationFirebaseMessagingService.class)
			mono.android.TypeManager.Activate ("ProjetGroupe.Droid.Services.PushNotificationFirebaseMessagingService, ProjetGroupe.Android", "", this, new java.lang.Object[] {  });
	}
